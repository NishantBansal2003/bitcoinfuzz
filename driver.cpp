...
namespace bitcoinfuzz
{
    ...
    void Driver::PrivateToPublicKeyTarget(std::span<const uint8_t> buffer) const
    {
        ...
        for (auto &module : modules)
        {
            std::optional<std::string> res{module.second->private_to_public_key(privkey_buffer)};
            if (!res.has_value()) continue;
            if (last_response.has_value()) {
                if (*res != *last_response) {
    ...
    void Driver::SignCompactTarget(std::span<const uint8_t> buffer) const
    {
        ...
        for (auto &module : modules)
        {
            std::optional<std::string> res{module.second->sign_compact(privkey_buffer, hash_buffer)};
            if (!res.has_value()) continue;
            if (last_response.has_value()) {
                if (*res != *last_response) {
    ...
    void Driver::SignDerTarget(std::span<const uint8_t> buffer) const
    {
        ...
        for (auto &module : modules)
        {
            std::optional<std::string> res{module.second->sign_der(privkey_buffer, hash_buffer)};
            if (!res.has_value()) continue;
            if (last_response.has_value()) {
                if (*res != *last_response) {
    ...
    void Driver::SignVerifyTarget(std::span<const uint8_t> buffer) const
    {
        ...
        for (auto &module : modules)
        {
            std::optional<bool> res{module.second->sign_verify(privkey_buffer, hash_buffer, sign_buffer)};
            if (!res.has_value()) continue;
            if (last_response.has_value()) {
                if (*res != *last_response) {
    ...
    void Driver::ECDHTarget(std::span<const uint8_t> buffer) const
    {
        ...
        for (auto &module : modules)
        {
            std::optional<std::string> res{module.second->ecdh(privkey_buffer)};
            if (!res.has_value()) continue;
            if (last_response.has_value()) {
                if (*res != *last_response) {
